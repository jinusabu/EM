                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="dep" type="text" class="form-control @error('dep') is-invalid @enderror" name="dep" value="{{ old('dep') }}" required autocomplete="dep">
                        ...
                        <div class="form-group row">
                            <label for="text" class="col-md-4 col-form-label text-md-right">{{ __('Qualification') }}</label>

                            <div class="col-md-6">
                                <input id="degree" type="text" class="form-control @error('degree') is-invalid @enderror" name="qualification" value="{{ old('qulification') }}" required autocomplete="degree">
